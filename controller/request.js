...
exports.createRequest = async (req, res) => {
    try {
        // Get the signUp id from the request
        const { id } = req.signUp;
...
exports.acceptRequest = async (req, res) => {
    try {
        // Get the admin id from the request signUp
        const adminId = req.signUp.id;
        ...
        group.members.push(request.signUpId);
